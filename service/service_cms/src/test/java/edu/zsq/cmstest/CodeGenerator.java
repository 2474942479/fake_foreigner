...
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir("E:\\IDEA\\project\\fake_foreigner\\service\\service_cms" + "/src/main/java");    //修改1 输出目录 projectPath改成绝对路径
        ...
        strategy.setInclude("edu_comment"); //修改5  修改为自己的表
